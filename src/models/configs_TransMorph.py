...
def get_2DTransMorph_platelet_config():
    ...
    config.img_size = (800, 800)
    return config


def get_2DTransMorph_phc_config():
    config = ml_collections.ConfigDict()
    config.if_transskip = True
    config.if_convskip = True
    config.patch_size = 4
    ...
    config.out_indices = (0, 1, 2, 3)
    config.reg_head_chan = 16
    config.img_size = (512, 704)
    return config

def get_2DTransMorph_small_platelet_config():
    config = ml_collections.ConfigDict()
    config.if_transskip = True
    config.if_convskip = True
    config.patch_size = 4
...
def get_2DTransMorph_small_phc_config():
    config = ml_collections.ConfigDict()
    config.if_transskip = True
    config.if_convskip = True
    config.patch_size = 4
