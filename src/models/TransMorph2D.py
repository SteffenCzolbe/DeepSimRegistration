...
import numpy as np
import src.models.configs_TransMorph as configs
...
class TransMorph2D(nn.Module):
    ...
    def forward(self, x):
        ...
        flow = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=False)(flow)
        
        return flow


CONFIGS2D = {
    'transmorph2d-small_platelet-em': configs.get_2DTransMorph_small_platelet_config(),
    'transmorph2d_platelet-em': configs.get_2DTransMorph_platelet_config(),
    'transmorph2d-small_phc-u373': configs.get_2DTransMorph_small_phc_config(),
    'transmorph2d_phc-u373': configs.get_2DTransMorph_phc_config(),
}