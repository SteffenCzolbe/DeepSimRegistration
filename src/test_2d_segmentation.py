...
def main(hparams):
    ...
    segmented_images[0].save(
        hparams.out, save_all=True, append_images=segmented_images[1:]
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default="./weights/phc-u373/segmentation/weights.ckpt",
        help="model checkpoint to initialize with",
    )
    parser.add_argument(
        "--out",
        type=str,
        default="./out/phc-u373/segmentation/segmentation.tif",
