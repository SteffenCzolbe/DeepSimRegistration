...
$WRAPPER_FUNC python3 -m src.train_segmentation --dataset hippocampusmr --max_steps 150000 --max_epochs 10000 --channels 128 128 128 --batch_size 4 --gpus -1 --lr 0.0001 --distributed_backend ddp
