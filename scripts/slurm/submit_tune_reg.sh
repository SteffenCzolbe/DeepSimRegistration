...
sbatch ./scripts/slurm/train_reg_phc_transfer_vgg.sh deepsim 0.125 --job-name='ph d 0.125' 
sbatch ./scripts/slurm/train_reg_phc_transfer_vgg.sh deepsim 0.25 --job-name='ph d 0.25' 
sbatch ./scripts/slurm/train_reg_phc_transfer_vgg.sh deepsim 0.5 --job-name='ph d 0.5' 
sbatch ./scripts/slurm/train_reg_platelet_transfer_vgg.sh deepsim 0.5 --job-name='pl d 0.5' 
sbatch ./scripts/slurm/train_reg_platelet_transfer_vgg.sh deepsim 1.0 --job-name='pl d 1.0' 
sbatch ./scripts/slurm/train_reg_platelet_transfer_vgg.sh deepsim 2.0 --job-name='pl d 2.0' 
