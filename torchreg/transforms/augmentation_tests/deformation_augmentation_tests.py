...
if __name__ == "__main__":
    ...
    affine_augment = transforms.RandomAffine(
        degrees=(-180, 180),
        translate=(-1, 1),
        scale=(0.9, 1.1),
        shear=(-0.03, 0.03),
    ...
    save_png(
        "./torchreg/transforms/augmentation_tests/post-transform/diffeomorphic.png",
        batch_diffeomorphic,
    )
    save_png(
        "./torchreg/transforms/augmentation_tests/post-transform/affine.png",
        batch_affine,
    )
    ...
    # save augmented images
    save_nii(
        "./torchreg/transforms/augmentation_tests/post-transform/diffeomorphic.nii.gz",
        nii,
        batch_diffeomorphic,
    )
    save_nii(
        "./torchreg/transforms/augmentation_tests/post-transform/affine.nii.gz",
        nii,
        batch_affine,
    )
